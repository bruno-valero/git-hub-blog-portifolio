...
interface OpenGraphIssueHeaderProps {
  title: string
  author: string
  createdAt: Date
  comments: number
...
export function OpenGraphIssueHeader({
  title,
  author,
  createdAt,
  comments,
}: OpenGraphIssueHeaderProps) {
  return (
    <div
    ...
    >
      ...
      <div tw="flex absolute top-[164px] h-[13.25rem] w-[54rem] items-center justify-center gap-8 border-none rounded bg-[#0B1B2B] p-8 shadow-xl outline-none">
        <div tw="flex w-full flex-col gap-6">
          ...
          <div tw="m-0 flex flex-col items-start justify-center gap-3 p-0">
            ...
            <div tw="mt-6 flex items-start justify-center gap-6 flex-col">
              ...
              <div tw="flex items-center justify-center gap-2 text-[16px] text-[#C4D4E3]">
                <span tw="text-nowrap">{comments} comentários</span>
              </div>
            </div>
          </div>
        </div>
